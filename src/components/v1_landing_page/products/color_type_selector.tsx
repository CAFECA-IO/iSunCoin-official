...
const ColorTypeSelector = () => {
  ...
  return (
    <section className="mx-auto flex max-w-1440px items-center justify-center py-40px">
      {/* Text */}
      <div className="flex-1 space-y-40px px-20px">
        ...
        <p className="text-lg font-semibold text-text-neutral-primary">
          Choose your preferred color, and it will be displayed in real-time on the device model to
          the right, providing you with a color reference.
        </p>
