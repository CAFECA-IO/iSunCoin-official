...
import KvAnimation from '@/components/animation/kv_animation';
...
const HeroSectionOfProducts = () => {
  ...
  return (
    <section className="mx-auto mb-30px max-w-1440px">
      <Slider {...settings}>
        <KvAnimation />
            ...
            <div className="flex basis-1/2 flex-col gap-40px pl-80px">
              ...
              <div>
                <p className="max-w-500px text-lg font-semibold text-text-neutral-tertiary">
                  ...
                  correction and AES 256-bit advanced encryption technology. It offers
            ...
            <div className="flex basis-1/2 flex-col gap-40px pl-80px">
              ...
              <div>
                <p className="max-w-500px text-lg font-semibold text-text-neutral-tertiary">
                  ...
                  correction and AES 256-bit advanced encryption technology. It offers faster and
                  more efficient transfer power and read speeds compared to the PRO model.
                </p>
              </div>
              <div className="flex flex-col gap-40px">
                <p>
        ...
        <section className="relative flex min-h-875px py-80px">
          ...
          <div className="z-10 flex">
            <div className="flex basis-1/4 flex-col gap-40px pl-80px">
              ...
              <div>
                <p className="max-w-500px text-lg font-semibold text-text-neutral-tertiary">
                  The Enterprise model features a water cooling system and a 2TB solid-state drive.
                  It has seven slots to accommodate high-power graphics cards, making it suitable
                  for handling complex data and running multi-layer machine learning models.
                </p>
              </div>
              <div className="flex flex-col gap-40px">
                <p>
