        ...
        >
          ...
          <div className="flex flex-col gap-8px text-sm">
            ...
            <input
              ...
              required
              className="w-full rounded-sm border border-input-stroke-input bg-transparent p-8px px-12px py-10px font-medium outline-none placeholder:text-input-text-input-placeholder"
            />
          </div>
