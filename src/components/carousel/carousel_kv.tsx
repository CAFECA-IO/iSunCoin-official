...
const CarouselKv = () => {
  ...
  return (
    <Slider {...settings}>
      <div className="relative flex border border-lime-500 py-80px">
        ...
        <div className="z-10 flex gap-54px">
          <div className="flex basis-1/2 flex-col gap-40px pl-80px">
            <div>
              <h3 className="text-9xl font-extrabold text-text-primary">PRO</h3>
          ...
          <div className="flex max-w-1/2 basis-1/2 items-center justify-center">
            <Image
      ...
      <div className="h-100vh max-w-1440px border border-rose-600">
        <h3>Slide 1</h3>
      </div>
      <div className="h-100vh max-w-1440px border border-rose-600">
        <h3>Slide 2</h3>
