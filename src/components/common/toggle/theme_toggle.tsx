...
const ThemeToggle = () => {
  ...
  return (
    ...
    >
      <div
        className={`flex h-32px w-32px items-center justify-center rounded-full bg-switch-surface-controller text-switch-text-primary shadow-md transition-transform ease-in-out ${isOn ? 'translate-x-30px' : ''}`}
      >
        {isOn ? (
          <svg
