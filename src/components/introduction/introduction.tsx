...
const Introduction = () => {
  return (
    <section className="flex h-660px flex-col gap-64px p-80px">
      <div className="flex flex-col gap-8px">
        <p className="text-center text-sm font-medium text-text-brand-primary-lv2">INTRODUCTION</p>
        <p className="text-center text-48px font-medium text-text-brand-secondary-lv1">
          What is iSunCoin
        </p>
      </div>
      <div className="flex gap-16px text-center text-lg font-medium text-text-neutral-primary">
        <div className="flex flex-col items-center gap-16px rounded-sm bg-surface-neutral-surface-lv1 px-20px py-16px shadow-card">
          <Image
